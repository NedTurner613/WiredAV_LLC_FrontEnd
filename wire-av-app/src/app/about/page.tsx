    ...
    <div className="min-h-screen bg-[#F3F7FE] font-body text-[#0F172A]">
      ...
      <section className="relative h-[540px] w-full overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
          ...
          <p className="max-w-xl text-lg md:text-xl text-[#E5E5E5] leading-relaxed">
            Wired Audio Video is more than an integrator. We are architects of
            atmosphere, bringing precision engineering and premium aesthetics to
            every smart space we design.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#F5F7F9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center">
          <ScrollReveal className="relative">
            ...
            <div className="absolute -bottom-10 -right-4 md:right-10 z-20 bg-[#F5F7F9] border border-[#D1D4D9] rounded-lg p-6 shadow-xl flex gap-12">
              <div className="text-center">
                <div className="text-4xl font-bold text-[#2563EB] font-heading">
                  15+
                </div>
                <div className="text-[10px] uppercase tracking-widest font-semibold text-[#6E727A] mt-1">
                  Years Experience
                </div>
              </div>
              <div className="text-center">
          ...
          <ScrollReveal className="space-y-6 lg:pl-12" delay={140}>
            <div className="space-y-2">
              <h2 className="text-4xl md:text-5xl font-medium font-heading uppercase tracking-[5px]">
                Our Story
              </h2>
              <div className="w-20 h-1 bg-[#2563EB]" />
            </div>
            <p className="text-lg font-medium text-[#6E727A]">
              Founded on the principle that technology should be invisible,
              intuitive, and impeccable.
            </p>
            <div className="space-y-4 text-[#6E727A] leading-relaxed">
              <p>
                Since our inception, Wired Audio Video has set the standard for
                high-end AV integration. We recognized early on that luxury
                living and modern business productivity required more than just
                hardware; they required a symphony of perfectly tuned components
                working in unison.
              </p>
              <p>
                What started as a specialized cabling firm has evolved into a
                full-service technology partner. Our team consists of certified
                engineers, visionary designers, and meticulous technicians who
                share a single obsession: performance without compromise.
              </p>
            </div>
      ...
      <section className="py-24 bg-[#f3f4f6] border-y border-[#D1D4D9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-8">
          {/* Mission Card */}
          <ScrollReveal className="relative bg-[#F5F7F9] p-10 rounded-2xl border border-[#D1D4D9] overflow-hidden group">
            <div className="absolute top-0 right-0 opacity-[0.05] translate-x-1/4 -translate-y-1/4">
              <Image
                ...
                width={192}
                height={192}
                className="w-48 h-48 text-[#2563EB]"
              />
            </div>
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-[#6E727A] italic leading-relaxed">
                &quot;To elevate human experiences through the masterful
                integration of audio, video, and automation technology, ensuring
                every interaction is seamless, reliable, and inspiring.&quot;
              </p>
            </div>
          </ScrollReveal>
          ...
          {/* Vision Card */}
          <ScrollReveal
            className="relative bg-[#F5F7F9] p-10 rounded-2xl border border-[#D1D4D9] overflow-hidden group"
            delay={140}
          >
            <div className="absolute top-0 right-0 opacity-[0.05] translate-x-1/4 -translate-y-1/4">
              <Image
            ...
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-[#6E727A] italic leading-relaxed">
                &quot;To remain the premier authority in smart-space
                integration, pioneering new standards of technical excellence
                that transform how people live, work, and connect.&quot;
              </p>
            </div>
          </ScrollReveal>
        </div>
      ...
      <section className="py-24 bg-[#F5F7F9]">
        <ScrollReveal className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-medium font-heading uppercase tracking-[5px] mb-4">
            Our Core Values
          </h2>
          <p className="text-[#6E727A] mb-6">
            The fundamental principles that guide every wire we pull and every
            system we program.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            {
              icon: "./assets/technical-integrity-icon.svg",
              title: "Technical Integrity",
              desc: "We believe in doing things right the first time. Our wiring is art, our racks are organized, and our code is clean.",
            },
            {
              icon: "./assets/client-partnership-icon.svg",
              title: "Client Partnership",
              desc: "We don't just sell systems; we build relationships. We listen to your needs and design solutions that fit your lifestyle.",
            },
            {
              icon: "./assets/continuous-support-icon.svg",
              title: "Continuous Support",
              desc: "Technology evolves, and so do we. We provide ongoing maintenance and proactive support to keep your systems peak.",
            },
            {
              icon: "./assets/attention-to-detail-icon.svg",
              title: "Excellence in Detail",
              desc: "The difference between a good system and a great one is in the final 2% of calibration. We obsess over the details.",
            },
            {
              icon: "./assets/legacy-quality-icon.svg",
              title: "Legacy Quality",
              desc: "We build systems intended to last. Our infrastructure is designed for scalability and long-term reliability.",
            },
            {
              icon: "./assets/logo.svg",
              title: "Bold Innovation",
              desc: "We stay at the forefront of AV technology, testing new innovations before they ever reach our clients' homes.",
            },
          ].map((value, idx) => (
            <ScrollReveal
              key={value.title}
              className="bg-[#F5F7F9]/50 backdrop-blur-sm p-8 rounded-lg border border-[#D1D4D9] shadow-sm hover:shadow-md transition-all"
              delay={idx * 80}
            >
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <ScrollReveal className="relative max-w-4xl mx-auto px-4 text-center text-white">
          <h2 className="text-3xl md:text-4xl font-medium font-heading mb-6">
            Driven by a Collective Passion
          </h2>
          <p className="text-lg md:text-xl text-[#E5E5E5] leading-relaxed mb-10">
            Behind every seamless installation is a team of specialists
            collaborating to solve complex challenges. Our technicians
            aren&apos;t just installers—they are artisans of the digital age.
          </p>
      ...
      <section className="py-24 bg-[#F5F7F9] border-t border-[#D1D4D9]">
        <ScrollReveal className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-medium font-heading mb-6">
            Ready to Experience the Difference?
          </h2>
          <p className="text-lg text-[#6E727A] mb-10">
            Whether you&apos;re planning a new build or upgrading an existing
            space, our experts are ready to bring your vision to life with
            technical precision and premium flair.
          </p>
                ...
                {[
                  {
                    ...
                    path: "./assets/instagram-icon.svg",
                  },
                  {
                    icon: "lucide:facebook",
                    path: "./assets/facebook-icon.svg",
                  },
                  {
                  ...
                  <a
                    key={i}
                    href="#"
                    className="text-[#6E727A] hover:text-[#2563EB] transition-colors"
                  >
